...
let visitorAgeRound = 60 * Math.random()
let visitorAge = Math.floor(visitorAgeRound)
...
let zooSummary = (creatureName + ":" + creatureDescription + ". Is it friendly: " + isFriendly + ". Your age is " + visitorAge + ". Can you visit? " + canVisit);
